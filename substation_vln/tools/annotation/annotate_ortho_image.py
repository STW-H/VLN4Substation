...
DEFAULT_CONFIG = CONFIGS_DIR / "tools" / "annotation" / "annotate_ortho_image_erfeishan.yaml"
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Annotate an orthographic image and convert labels to real XY.",
        parents=[pre_parser],
    )
